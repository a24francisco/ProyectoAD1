...
public class Usuario {
    ...
    private List DesserializarBusqueda() {
        ...
        if (file.exists()) {
            try (FileInputStream fis = new FileInputStream(nombre + ".src"); ObjectInputStream ois = new ObjectInputStream(fis);) {
    ...
    private List DesserializarLista() {
        ...
        if (file.exists()) {
            try (FileInputStream fis = new FileInputStream(nombre + ".list"); ObjectInputStream ois = new ObjectInputStream(fis);) {
    ...
    public boolean crearPersonaje(Personaje p) {
