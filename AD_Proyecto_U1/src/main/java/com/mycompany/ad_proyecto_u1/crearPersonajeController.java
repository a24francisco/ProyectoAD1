...
public class crearPersonajeController {
    ...
    public crearPersonajeController(crearPersonajeJDialog view) {
        ...
        ActionListener al = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae) {
               ...
               String nombre = view.getName();
                ...
                Personaje p = Personaje.crearPersonaje(id, id, frase, genero, frase, trabajo, List.of(frase), cumpleaños, frase);
                u.crearPersonaje(p);
